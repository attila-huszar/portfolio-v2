...
export default function Header() {
  ...
  return (
    <header className="relative z-[999]">
      <motion.div
        className="fixed left-1/2 top-0 h-[4.5rem] w-full rounded-none border border-white/40 bg-white/80 shadow-lg shadow-gray-500/20 backdrop-blur dark:border-black/40 dark:bg-gray-950/75 dark:shadow-gray-900/50 sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full"
